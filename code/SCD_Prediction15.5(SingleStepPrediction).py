...
userTrip_df.to_csv(r'G:\Program\Pycharm Projects\File of Python3\SCD_System\result\data\singlestep_data\userPredictionTrips.csv',
                   index=False)
    ...
    for testday in testday_ls:
        ...
        for i in range(11,49):
            ...
            if nextPredictionState in ['Work-to-Home','Other-to-Home','Home-to-Work','Other-to-Work','Home-to-Other','Work-to-Other','Other-to-Other',]:
                ...
                trip_P_df.to_csv(r'G:\Program\Pycharm Projects\File of Python3\SCD_System\result\data\singlestep_data\userPredictionTrips.csv',mode='a',index=False,header=False)
...
userAttribute_df.to_csv(r'G:\Program\Pycharm Projects\File of Python3\SCD_System\result\data\singlestep_data\userAttribute(accuracy).csv')
