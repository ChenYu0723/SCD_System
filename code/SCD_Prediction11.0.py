...
def SCD_Prediction():
    ...
    userAttribute_df = pd.DataFrame(index=userTrips.keys(),columns=columns)
    ...
    for u_id in userTrips.keys():
        ...
        userTrips_df2 = userTrips_df[userTrips_df.transDate.isin(Date_list)]
        userTrips_df2 = userTrips_df[userTrips_df.timeSlot.isin(timeSlotLimit)]
        # print userTrips_df2
