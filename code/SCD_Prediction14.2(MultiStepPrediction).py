...
def SCD_Prediction():
        ...
        for i in range(11,49):
            ...
            if tripProbability_ls[i -11] == 1:
                ...
                if i <= 18:
                    ...
                    thisTS_MXls[9] = 0
                thisTS_max = max(thisTS_MXls)
                if lastPredictionState in ['Work-to-Home','Other-to-Home','Home-to-Work','Other-to-Work','Home-to-Other','Work-to-Other','Other-to-Other']:
                    thisTS_max = 0
                if thisTS_max != 0:
                    for key, val in state_dic.items():
                        if val == thisTS_MXls.index(thisTS_max):
                    ...
                    if lastPredictionState in ['stay at home','Work-to-Home','Other-to-Home']:
                        nextPredictionState = 'stay at home'
                    elif lastPredictionState in ['stay at work','Home-to-Work','Other-to-Work']:
    ...
    print('# non trip user:',non_tripuser)
