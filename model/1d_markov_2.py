...
def SCD_Prediction():
    ...
    # print(TripDataFrame2)
        ...
        Test_df = TripDataFrame2[TripDataFrame2['transDate'].map(lambda x: 20170801 <= x <= 20170831)]  # test time
        # print(Test_df)
        Test_df_ls = Test_df['transDate'].tolist()
        Train_df = TripDataFrame2[TripDataFrame2['transDate'].map(lambda x: x not in Test_df_ls)]
        # print(Train_df)
    ...
    print('The user count1:', userCount)
    print('The user count2:', userCount2)
    print('The accuracy1:', numAccurate_1)
    print('The accuracy2:', numAccurate_2)
    print('The accuracy3:', numAccurate_3)

    numAccurate = numAccurate_1 + numAccurate_2 + numAccurate_3
    acc = float(numAccurate)/float(userCount2)
    print('The accuracy:',acc)
    # 8: The accuracy: 0.7761
    # 7: The accuracy: 0.73398
    # 6: The accuracy: 0.72285
    # 5: The accuracy: 0.67628

    with open(r'model/prediction_accuracy.txt','a') as f:
        f.write('\n')
